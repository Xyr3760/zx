...
# Author  : Bogel Tunneling
# (C) Copyright 2020-2024 By Bogel Tunneling
# =========================================
...
echo -e "         OWNER : ${GREEN} zx ${NC}${YELLOW}(${NC} ${GREEN} Ziero Xion  ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By Ziero Xion ${YELLOW}(${NC} 2024-2025 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
